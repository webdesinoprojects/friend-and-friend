    ...
    <UserAppLayout title="Reviews">
      <section className="min-h-full rounded-[1.5rem] border border-[#eddac7] bg-[#fffaf3] p-4 shadow-sm lg:p-6">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <ReviewColumn title="Reviews about you" reviews={received} empty="Provider reviews about you will appear after completed bookings." canReport />
  ...
  return (
    <section className="rounded-2xl border border-[#eddac7] bg-white p-5">
      ...
      <div className="mt-4 grid gap-3">
        {reviews.length ? (
          reviews.map((review) => <ReviewCard key={review.id} review={review} canReport={canReport} />)
        ) : (
